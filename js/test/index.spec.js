...
describe('index', () => {
  ...
  describe('#constructor', () => {
    it('has methods to match credstash', () => {
      ...
      credstash.getAllSecretsFiltered.should.exist;
  ...
  describe('#getAllSecretsFiltered', () => {
    let items;
    let kms;

    const item1 = encryption.filteredItem;
    const item2 = encryption.filteredCredstashKey;
    ...
    it('should return all secrets', () => {
      const credstash = defCredstash();
      return credstash.getAllSecretsFiltered({ context: { project: 'credstash', env: 'test' } })
        .then((res) => {
          Object.keys(res).length.should.equal(2);
          const unsorted = Object.keys(res);
          const sorted = Object.keys(res).sort();
